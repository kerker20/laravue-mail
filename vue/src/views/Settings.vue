    ...
    <main>
        <div class="flex flex-no-wrap bg-gray-200 h-screen">
                ...
                <div class="px-8 h-screen">
                    ...
                    <ul class="mt-4">
                        <router-link :to="{name: 'Dashboard'}"
                            class="flex w-full justify-between text-gray-400 hover:text-gray-500 cursor-pointer items-center mb-6"
                        >
                        ...
                        >
                            <div class="flex items-center">
                                ...
                                <span class="text-sm ml-2 text-gray-400">Templates</span>
                            </div>
                        </router-link>
                        <li
                        ...
                        >
                            <div class="flex items-center">
                                ...
                                <span class="text-sm ml-2 text-blue-500">Settings</span>
                            </div>
                        </li>
                    </ul>
            ...
            >
                    ...
                    <ul class="mt-4">
                        ...
                        >
                            <div class="flex items-center">
                                ...
                                <span class="text-sm ml-2 text-gray-400">Campaigns</span>
                            </div>
                            <!-- <div class="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">5</div> -->
                        </router-link>
                        <router-link :to="{name: 'Templates' }"
                ...
                <div class="px-8 border-t border-gray-700 mt-10">
                    <ul
                        class="w-full flex items-center justify-between bg-gray-800"
                    >
                        <li class="cursor-pointer text-white pt-5 pb-3">
